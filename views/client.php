        ...
        <div class="main-content">
            <main>
                <div class="container mt-5">
                    <h1 class="mb-4">Perusahaan yang Sering Bekerja Sama dengan Klub Motor</h1>
                    <a href="../views/tambahClient.php" class="btn btn-primary mb-4">Tambah Data</a>
                    <div class="row">
                        <!-- Card 1 -->
                        <?php
                        include "../config/koneksi.php";

                        $data = mysqli_query($db, "SELECT * FROM client");

                        // Melakukan loop untuk setiap baris hasil query lalu ditampilkan
                        while ($array = mysqli_fetch_array($data)) {
                        ?>
                            <div class="col-md-4">
                                <div class="card">
                                    <img src="https://via.placeholder.com/350x200?text=<?php echo $array['merek']; ?>" class="card-img-top" alt='<?php echo $array['merek']; ?>'>
                                    <div class="card-body">
                                        <h5 class="card-title"><?php echo $array['merek']; ?></h5>
                                        <p class="card-text"><?php echo $array['deskripsi']; ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php
